...
import os
import divide
import generate_classification_negative_examples
...
for folder in [x[0] for x in os.walk(args.root)]:
    ...
    if os.path.exists(graph_file) and os.path.exists(positive_examples_file): 
        ...
        generate_classification_negative_examples.generate_negative_examples(graph_file,positive_examples_file,args.num_examples,args.name_output)
